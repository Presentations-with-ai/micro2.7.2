...
function shouldBlockCopyInteraction(target) {
  // Если пользователь премиум — сразу разрешаем копирование
...
function isPremiumOnlyTestMode(mode) {
  ...
  return normalizedMode === TEST_MODE_REGULAR
    || normalizedMode === TEST_MODE_SPEED
    || normalizedMode === TEST_MODE_UNTIMED;
}
